---
title: "Probability and Mathematical Communication"
subtitle: "Grade 5 practice workbook"
lang: en-US
header-left: "Probability and Communication"
...
::: {.problem #p04-01}
**1.** A jar has 4 green, 3 yellow, and 1 purple marble. What is P(yellow)?

\workarea{50mm}
:::
::: {.problem #p04-02}
**2.** From the same jar, what is P(not purple)?
...
Use P(event) + P(not event) = 1.

::: {.problem #p06-01}
**1.** A spinner has 8 equal sections; 3 are orange. Find P(not orange).
...
::: {.problem #p12-01}
**1.** How many tiles are there? Find P(green).

\workarea{50mm}
:::
::: {.problem #p12-02}
**2.** Find P(red or blue).
...
::: {.problem #p13-01}
**1.** List the sample space for two tosses and find P(two heads).

\workarea{50mm}
:::
::: {.problem #p13-02}
**2.** Find P(exactly one head) for two tosses.
...
::: {.problem #p14-01}
**1.** A bag has 2 red and 1 blue counter. List the four possible color pairs and find P(red then red).

\workarea{50mm}
:::
::: {.problem #p14-02}
**2.** For the same bag and replacement, find P(one red and one blue in either order).
...
::: {.problem #p17-01}
**1.** A prize wheel has 10 equal spaces: 4 toys, 3 books, 2 games, and 1 sticker. What is P(a book or game)?
...
::: {.problem #p19-01}
**1.** A bag has 3 red, 4 blue, and 5 green cubes. Find P(not green) and explain your count.
...
:::
::: {.problem #p20-02}
**2.** Write a short rule for finding theoretical probability, then apply it to P(rolling less than 3) on a fair die.
