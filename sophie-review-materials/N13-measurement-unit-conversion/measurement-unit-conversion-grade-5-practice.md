...
Use $12$ inches $=1$ foot, $3$ feet $=1$ yard, and $5{,}280$ feet $=1$ mile.
...
::: {.problem #p09-01}
**1.** $3$ meters ___ $280$ centimeters

\workarea{48mm}
:::
::: {.problem #p09-02}
**2.** $2$ kilograms ___ $1{,}950$ grams
...
::: {.problem #p10-01}
**1.** Find $2$ m $45$ cm $+1$ m $80$ cm. Give the answer in meters and centimeters.

\workarea{55mm}
:::
::: {.problem #p10-02}
**2.** Find $5$ kg $200$ g $-2$ kg $750$ g. Give the answer in grams.
...
Use $60$ seconds $=1$ minute, $60$ minutes $=1$ hour, and $24$ hours $=1$ day.
...
Area measures the space inside a rectangle. Use $A=length\times width$.
...
For a rectangular prism, use $V=length\times width\times height$.
