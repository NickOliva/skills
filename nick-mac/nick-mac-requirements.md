...
- **FluidVoice AI enhancement:** off in the standard. Dictation transcribes without AI rewriting; disable the AI editing shortcut. Keep local speech recognition. Enhancement providers/models are not required; already downloaded models may remain inactive.
